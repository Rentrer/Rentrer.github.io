...
//     if (location.pathname.startsWith('/about/')) shenyyu.comments(), shenyyu.Introduction(), shenyyu.runtimen(), shenyyu.fiftyonela();
// }
...
var shenyyu = {
    comments: function() {
        fetch('/article.json')
            ...
            .then(articleData => {
                ...
                fetch('https://twikoo.shenyyu.site/', {
                        method: "POST",
    ...
    runtimen: function() {
        let t = new Date("2024/01/12 02:13:00")
            .getTime(),
            n = new Date()
            .getTime(),
        ...
        c && (c.innerHTML = `已稳定运行 ${l} 坤年 🏀`),
            setTimeout(shenyyu.runtime, 1e3);
    }, // about 运行时间
    fiftyonela: function() {
            fetch('https://v6-widget.51.la/v6/3HC404kfiLsgJ8UK/quote.js')
                .then(res => res.text())
                .then((data) => {
